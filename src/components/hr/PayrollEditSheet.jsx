          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field label="Allowances (RM)">
                <Input type="number" min="0" step="0.01" value={form.allowances} onChange={setNum("allowances")} className={inputCls} />
              </Field>
              <Field label="Deductions (RM)">
                <Input type="number" min="0" step="0.01" value={form.deductions} onChange={setNum("deductions")} className={inputCls} />
              </Field>
